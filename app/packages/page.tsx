...
const packages = [
  {
    ...
    inclusions: [
      { name: 'Super Deluxe', description: 'Premium room with upgraded comfort' },
  ...
  },
  {
    ...
    description: 'Perfect family getaway with spacious suite accommodation, fun activities for kids, and sightseeing tour of Kodaikanal\'s best attractions. Create wonderful memories with your loved ones in the hills.',
    shortDescription: '3-night family suite stay with sightseeing',
    ...
    inclusions: [
      { name: 'Family Suite', description: 'Spacious suite for families and groups' },
      ...
      { name: 'BBQ Evening', description: 'BBQ dinner ' },
  ...
  },
  {
    ...
    roomType: 'Deluxe',
    inclusions: [
      { name: 'Deluxe', description: 'Comfortable room with essential amenities' },
      { name: 'Daily Breakfast', description: 'Breakfast for 2 at our restaurant' },
