...
export default function GalleryPage() {
  return <><Header /><main className="rooms-neu-scene min-h-screen text-forest-800 dark:text-white">
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <p className="max-w-2xl text-lg text-forest-600 dark:text-mist-300 mb-10">Explore Apple Valley in Kodaikanal, from guest rooms and restaurant interiors to celebrations, artwork, play areas, and outdoor spaces. Browse by category to take a closer look.</p>
      <Gallery />
